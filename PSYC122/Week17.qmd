...
::: callout-tip
In week 17, we will ask you to do three things.
...
- [The slides](data/week17/122-linear-model-intro-printable-edit.docx) converted to a Word .docx (1 MB). 
...
In the activity @sec-wk6-lab-activities-2, we are going to work through the following tasks.
...
You will see that you can match a task in the activity @sec-wk6-lab-activities-2 to the same task in the `how-to` guide.
...
4. An answers version of the workbook will be provided after the last lab session (check the answers then in @sec-wk6-lab-activities-answers) so that you can check whether your independent work has been correct.
:::
...
We set out the week 17 *Hypotheses, associations* questions below.
...
<!-- ### Answers {#sec-wk6-lab-activities-answers-information}  -->

<!-- ::: callout-tip -->
<!-- Click on a box to reveal the answer. -->
<!-- ::: -->

<!-- #### Questions {#sec-wk6-lab-activities-1-questions-answers} -->
