...
This module builds on the knowledge and skills acquired in Statistics for Psychologists 1 (PSYC121). You will continue to practise data handling, data processing and data visualisation, using R and R Studio. In addition, you will learn about statistical methods to test whether two (or more) variables are associated and how to implement those methods in R and R Studio. For instance, lets consider a simple example involving two variables (denoted X and Y): Does the rating of an individual's "likability" (Y) have anything to do with physical attractiveness (X)? So we want to know whether one variable (Y) is related to another variable (X). We will look at different measures of association, depending on the underlying nature of the measurements, look at factors that affect measures of association and expand this to regression and getting an understanding of the linear model.
