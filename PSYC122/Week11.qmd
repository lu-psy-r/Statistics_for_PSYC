...
Start a new RMarkdown script. If you need a reminder of how to do that, please revisit week 6 of PSYC121 ([here](https://lu-psy-r.github.io/statistics_for_psychologists/PSYC121/Week6.html#some-basic-rmarkdown)).
...
2.  Read in the data. You should now see a dataframe with 25 observations and 5 variables in the 'Environment'. Click on it to view it.
...
::: {.callout-tip collapse="true"}
## Hint 2
Below is a template of the code, make sure to add the dataframe and the relevant variable names. Also add clear labels for your axes.
```
ggplot(DATA, aes(x = , y = )) + 
  geom_point() +
