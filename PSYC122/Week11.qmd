...
The folder you were asked to download under 'Pre-lab activity 4: Getting ready for the lab class' contains the datafile ("MillerHadenData.csv").
...
2.  Add the code to load the 'broom' and the 'tidyverse' libraries.
...
The code to do this is below. You can copy it by clicking on the clipboard in the top right corner.
```
library(broom)
library(tidyverse)
```
...
5.  What can you tell from the scatterplot about the direction of the relationship?
