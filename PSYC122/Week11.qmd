...
1.  Start a new RMarkdown script. If you need a reminder of how to do that, please revisit week 6 of PSYC121 ([here](https://lu-psy-r.github.io/statistics_for_psychologists/PSYC121/Week6.html#some-basic-rmarkdown)).

2.  Add the code to load the 'broom' and the 'tidyverse' libraries in a new code chunk. If you are unsure, you can look at the 'Hint' below for a clue by expanding it. After that, if you are still unsure, you can view the code by expanding the 'Code' section below. 

::: {.callout-tip collapse="true"}
## Hint
Use the `library()`function. Remember to put it inside a 'code block' in your R Markdown script by putting it inside two sets of ```.
:::
...
4.  Construct a scatterplot of the relationship between 'Home' and 'TV'.
...
```
:::
5.  What can you tell from the scatterplot about the direction of the relationship? Write a few sentences in your R Markdown script to 
