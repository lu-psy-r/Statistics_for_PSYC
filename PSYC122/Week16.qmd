...
2. We will not always give you the code you need so you can check what you have learned.
3. We will not give you the answers to questions about the data or about the results of analyses. 
4. An answers version of the workbook will be provided at the end of the week (see @sec-wk6-lab-activities-answers) so you can check whether your independent work has been correct.
:::
...
When you code this, give the data object you create a clear name 
e.g. `study.two.gen`.
...
**It can be hard to decide what an association looks like so make a decision based on what you see and *trust your instincts* right now**
...
::: callout-tip
- We teach this because we know that some of our alumni get jobs after they develop pro visualization skills
with us.
...
- You can download the script [here]() when it is available.
:::
