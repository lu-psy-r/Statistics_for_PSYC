...
2.  **How to -- How to build a linear model in R**(~? minutes)
...
Download the [122_week12_forStudents.zip](data/week13/122_week13_forStudents.zip) file and upload it into the new folder in RStudio Server you created (see last week's Pre-lab activity 4 for instructions on how to do that.
...
> **Step 4.**: Descriptive statistics. We now need descriptive statistics for both variables. Calculate the mean and standard deviations for the anxiety scores and the engagement data.
