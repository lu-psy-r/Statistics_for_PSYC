...
1. **Overview** (19 minutes): What we are doing in Week 19 -- Exploring the power of linear models, extending their application to use multiple variables to predict people.
...
- [The slides](data/week19/122-linear-model-perspectives.html) exactly as presented (6 MB).
- [The slides](data/week19/122-linear-model-perspectives-printable-edit.docx) converted to a Word .docx (1 MB). 
...
### The lectures have three main areas of focus {#sec-wk19-lectures-focus}
...
- Try out the coding exercises in the how-to guide and the acitivity tasks or questions (@sec-wk19-lab-activities) to learn how to construct visualizations and do analyses.
:::
...
### Pre-lab activity alternative option {#sec-wk19-prelab-activities-2}
...
- There is a little bit of variation, comparing the later steps in the `how-to` guide and the steps in @sec-wk19-lab-activities-2, but that is designed to help you with your learning, in different places, when we think you will most need the support.
...
In @sec-wk19-lab-activities-2, you will see that we show you how you can understand what linear model estimates show by examining the predictions from one outcome-predictor relation.

**Step 6: Draw boxplots to examine associations between variables**

The `how-to` guide shows you how to produce boxplots. 
We do not include the task in the @sec-wk19-lab-activities-2 tasks sequence but you *will* find it useful to produce boxplots when you are examining the impact of categorical variables (next).
...
You can see example code, for a different model, for Step 4 in the `2023-24-PSYC122-w19-how-to.Rmd`.
...
You can see example code, for a different model, for Step 5 in the `2023-24-PSYC122-w19-how-to.Rmd`.
...
We set out answers information the Week 19 **Developing the linear model** questions, below.
