...
3. Get the `2023-24-PSYC122-w19-how-to.Rmd` how-to guide
...
::: callout-tip
We show you how to do everything you need to do in the lab activity (@sec-wk19-lab-activities-2, next) in the `how-to` guide.
