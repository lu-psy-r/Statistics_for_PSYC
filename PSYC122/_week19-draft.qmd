...
>**hint: Q.27.** We can look at the estimates but we can also use model prediction plotting code to *visualize* the results. You can build on the code you used before, see:
