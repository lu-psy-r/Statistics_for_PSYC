...
- You can download the script by clicking on the link:  [2023-24-PSYC122-w19-workbook-answers.Rmd](data/week18/2023-24-PSYC122-w19-workbook-answers.Rmd).
...
```{r eval=FALSE}
download.file("https://github.com/lu-psy-r/statistics_for_psychologists/blob/main/PSYC122/data/2023-24-PSYC122-w19-workbook-answers.Rmd?raw=true", destfile = "2023-24-PSYC122-w19-workbook-answers.Rmd")
```
:::
