...
Using the instructions and advice given on Moodle, get the `week2.zip` file and bring the data and R script into R Studio. [The week 2 zip file is here](data/Week_2/week_2_2023.zip)
