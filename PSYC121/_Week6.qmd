...
1. The "World" removes some cards from the full deck (the number and colour of the cards removed is up to them) and they place these face down on the table. They shuffle the chosen cards ready to start the "experiment".
...
-   Mark down whether the card was red or black in [your logbook](data/Week_6/Week_6_card_logbook.docx)
