...
-   Make sure you have access to the `week4.zip` file for the RStudio server. [You can get the file here](data/Week_4/week_4_2023.zip).
...
The following are parody music videos about stats. Now that you have a few weeks' experience with R Studion and also, an introduction to hypothesis testing, you might appreciate the following
